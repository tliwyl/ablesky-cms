<template>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			...
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" @click="addNewOne">添加店铺/校区</el-button>
				</el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="age" label="店铺名称" width="180" >
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="姓名" prop="name">
					<el-input v-model="editForm" auto-complete="off"></el-input>
				</el-form-item>
				...
				<el-form-item label="地址">
					<el-input type="textarea" v-model="editForm"></el-input>
				</el-form-item>
			</el-form>
